...
voting_classifier_model = load_model('voting-SMOTE.pkl')
xboost_SMOTE_model = load_model('xgboost-SMOTE.pkl')
...
def prepare_input(credit_score, age, tenure, balance, num_products,
  ...
  input_dict = {
      ...
      'Geography France': 1 if location == 'France' else 0,
      'Geography Germany': 1 if location == 'Germany' else 0,
      'Geography Spain': 1 if location == 'Spain' else 0,
...
def explain_prediction(probability, input_dict, surname):
  ...
  Here is the customers's information:
  {input_dict}
  ...
  Here are the machine learning model's top 10 most important features for predicting churn:
    ...
    Don't mention the probability of churning, or the machine learning model, or say anything like     "Based on the machine learning model's prediction and top 10 most important features"e just         explain the prediction.
...
if selected_customer_option:
  ...
  input_df, input_dict = prepare_input(credit_score, age, tenure, balance,
